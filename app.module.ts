...
import {TemplateCompComponent} from '../template-comp/template-comp.component';
import {TemplateDrivenFormCompComponent} from '../template-driven-form-comp/template-driven-form-comp.component';
import {MyserviceServiceService} from '../template-driven-form-comp/myservice-service.service';
...
@NgModule({
  ...
  providers: [DataService, DataSharingServiceService, ServicesService, MyserviceServiceService],
